      ...
      <div className="overflow-x-hidden pb-5">
        <div className="flex w-screen items-center flex-1 mt-5 justify-center">
          ...
          <div className="flex items-center ml-7 max-w-xl w-full h-14 bg-slate-50 rounded-lg">
            <input
              className="flex flex-1 outline-none h-full bg-transparent font"
          ...
          <a
            href="#"
            className="ml-12 border-b text-[#474747] border-[#474747]"
          >
            Cadastre-se
          </a>
          <button className="bg-[#C92071] text-white px-14 py-2 ml-7 rounded-lg hover:bg-[#c92058]">
            Entrar
          </button>
          <img
            className="ml-16"
            src="/carrinho_de_compras.png"
